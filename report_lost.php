        ...
        <div class="form-container">
            ...
            <form method="POST" action="handlers/process_report_firebase.php" class="report-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="item_name" name="item_name" required placeholder="e.g., Blue Backpack, iPhone 14">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="location" name="location" required placeholder="e.g., Library, Cafeteria, Main Hall">
                </div>
