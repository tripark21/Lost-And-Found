    ...
    <div class="form-wrap">
        <div class="form-shell">
            <div class="form-top">
                ...
                <p>Provide as much detail as possible to improve your chances of recovery.</p>
            </div>
            <div class="form-body">
                ...
                <form method="POST" action="handlers/process_report_postgres.php" class="report-form" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="item_name" required placeholder="e.g., Blue Backpack, Samsung Galaxy">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="4" required placeholder="Color, brand, distinguishing features, contents…"></textarea>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="location" required placeholder="e.g., Main Library 2F">
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-accent btn-lg">Submit Lost Report</button>
