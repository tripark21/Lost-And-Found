...
$cat_stmt = $conn->prepare("SELECT DISTINCT category FROM items WHERE item_type = 'found' ORDER BY category");
$cat_stmt->execute();
...
<div class="container">
    ...
    <div class="search-section">
        <form method="GET" class="search-form">
            ...
            <a href="found_items_postgres.php" class="btn btn-secondary">Clear</a>
        </form>
    </div>
    ...
    <div class="items-grid">
        ...
        <?php else: ?>
            <div class="no-items">
                <p>📦 No found items<?php echo ($search || $category) ? ' matching your search' : ' at the moment'; ?>. Check back soon!</p>
            </div>
        <?php endif; ?>
    </div>
</div>
