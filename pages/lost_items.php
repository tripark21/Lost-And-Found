...
$categories = $conn->query("SELECT DISTINCT category FROM items WHERE item_type='lost' ORDER BY category");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="lost_items.php" class="active">Lost Items</a></li>
    ...
    <div class="container">
        ...
        <div class="search-section">
            <form method="GET" class="search-form">
                <input type="text" name="search" placeholder="Search lost items..." value="<?php echo $search; ?>">
                ...
                <a href="lost_items.php" class="btn btn-secondary">Clear</a>
            </form>
        </div>
        ...
        <div class="items-grid">
            <?php if (count($items) > 0): ?>
                <?php foreach ($items as $item): ?>
                    <div class="item-card">
                        ...
                        <p class="item-date">Lost: <?php echo date('M d, Y', strtotime($item['date_reported'])); ?></p>
            ...
            <?php else: ?>
                <div class="no-items">
                    <p>No lost items found. Check back soon!</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
