...
// Get all lost items
$allItems = getAllItems('lost', 'unresolved');
...
<head>
    ...
    <title>Lost Items - Lost & Found System</title>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li><a href="lost_items_firebase.php" class="active">Lost Items</a></li>
        ...
        <div class="search-section">
            <form method="get" class="search-form">
                ...
                <?php if ($search || $category): ?>
                    <a href="lost_items_firebase.php" class="btn-secondary">Clear Filters</a>
                <?php endif; ?>
            </form>
        </div>

        <?php if (empty($items)): ?>
            <p class="no-items">No lost items found. Try a different search or check back soon!</p>
        <?php else: ?>
